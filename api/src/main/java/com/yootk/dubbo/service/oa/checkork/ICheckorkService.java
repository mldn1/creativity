...
public interface ICheckorkService {
        ...
        /**
         * 根据雇员eid（emp表中）查询出该全部的所有考勤记录
         * @param eid 用户id
         * @param currentPage 当前页
         * @param lineSize 每页存放的长度
         * @return 返回Checkork（考勤表）的list集合（还要返回用户的姓名）
         */
        //public Map<String,Object> list2(Long eid, Long currentPage, Integer lineSize, String column, String keyword) ;
