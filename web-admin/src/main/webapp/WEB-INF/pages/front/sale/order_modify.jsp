        ...
        <form action="?action=main&exec=Marketing_orderss&fun=editData" method="post" name="viewEdit" id="viewEdit">
            <table width="98%" class="table table-striped table-hover table-bordered">
                    ...
                    <td>
                        <div id="order_cls_div" class="col-sm-3">
                            ...
                            <c:forEach items="${allOrderType}" var="orderType">
                                <option	value="${orderType.title}" ${orderType.id==preEditOrder.ordertype ? "selected='selected' ":''}>
                ...
                <tr>
                    <td>支付渠道</td>
                    <td>
                        <div id="pay_source_div" class="col-sm-3"><select name="pay_source" id="pay_source"
                                                                          class="form-control">
                            <option value="">请选择</option>
                ...
                <tr>
                    <td>支付状态</td>
                    <td>
                        <div id="pay_state_div" class="col-sm-3"><select name="pay_state" id="pay_state"
                                                                         class="form-control">
                            <option value="">请选择</option>
                ...
                <tr>
                    <td>送货信息</td>
                    <td>
                        <div class="col-sm-5"><input name="addr_name" type="text" id="addr_name" size="50"
                                                     value="收货人：涂小熳" class="form-control"/>
                        </div>
                        <div class="col-sm-5"><input name="addr_tel" type="text" id="addr_tel" size="50"
                                                     value="收货电话：155*****" class="form-control"/>
                        </div>
                        <div class="col-sm-5"><input name="addr_addr" type="text" id="addr_addr" size="50"
                                                     value="收货地址：XXXXXX" class="form-control"/>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>发票信息</td>
                    <td>抬头：${allInvoice[invoice.head]}|&nbsp;内容：${allInvoice[invoice.name]}|&nbsp;金额：${allInvoice[invoice.price]}|&nbsp;税号：${allInvoice[invoice.num]}|&nbsp;
                        <div id="_div" class="col-sm-3"><select name="" id="" class="form-control">
                            <option value="">请选择</option>
                            <%--<c:forEach items="${allInvoiceState}" var="invoicState">
                            <option	value="${invoicState.title}" ${invoicState.id==preEditOrder.InvoiceState ? "selected='selected' ":''}>
                                    ${invoicState.title}</option>
                            </c:forEach>--%>
                ...
                <tr>
                    <td>订单备注</td>
                    <td>
                        <div class="col-sm-5"><textarea name="remarks" id="remarks" cols="15" rows="5"
