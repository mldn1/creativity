...
<form action="?action=main&exec=Marketing_orderss&fun=editData" method="post" name="viewEdit" id="viewEdit">
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
            <tr>
        <td>id</td>
        <td><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value="16550"  class="form-control"  readonly />
</div></td>
      </tr>
            <tr>
        <td>购买用户</td>
...
<option value="-1" selected>关闭/退换</option>
...
<option value="9">已对账确认</option>
            ...
            <tr>
        <td>送货信息</td>
        <td><div class="col-sm-5"><input name="addr_name" type="text" id="addr_name" size="50" value="收货人：涂小熳"  class="form-control"   />
</div><div class="col-sm-5"><input name="addr_tel" type="text" id="addr_tel" size="50" value="收货电话：155*****"  class="form-control"   />
</div><div class="col-sm-5"><input name="addr_addr" type="text" id="addr_addr" size="50" value="收货地址：XXXXXX"  class="form-control"   />
</div></td>
      </tr>
            <tr>
        <td>物流信息</td>
        ...
        <td></td>
            ...
            <tr>
        <td>支付信息</td>
        <td>商品总金额：265.00&nbsp;|&nbsp;应付金额：283.00&nbsp;|&nbsp;优惠金额：0.00&nbsp;|&nbsp;支付渠道：微信&nbsp;|&nbsp;支付方式：在线&nbsp;|&nbsp;实际支付金额：0.00&nbsp;|&nbsp;付款状态：<font color="#A00000">未支付</font></td>
      </tr>
            <tr>
        <td>发票信息</td>
