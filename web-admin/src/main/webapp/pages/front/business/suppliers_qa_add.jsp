  ...
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
        ...
        <td><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value=""  class="form-control"   readonly />
            ...
            <tr>
        <td>订单号</td>
        <td><div class="col-sm-5"><input name="oid" type="text" id="oid" size="50" value="GGP20190626192908714564a8"  class="form-control"   readonly />
</div></td>
      </tr>
            <tr>
        <td>类型</td>
...
<option value="3">换货</option>
            ...
            <tr>
        <td>原订单号</td>
        <td><div class="col-sm-5"><input name="return_source_oid" type="text" id="return_source_oid" size="50" value=""  class="form-control"   />
</div></td>
      </tr>
            <tr>
        <td>供应商名称</td>
...
<option value="">请选择</option>
        ...
        <td><div class="col-sm-5"><textarea name="remarks" id="remarks" cols="30" rows="10"  class="form-control"   ></textarea>
            ...
            <tr>
        <td>状态</td>
        <td><div id="state_div" class="col-sm-3"><select name="state" id="state" class="form-control"  onChange="getStateSelect('GGP20190626192908714564a8', this.options[this.options.selectedIndex].value);">
<option value="">请选择</option>
...
function getProductList(ids) {
	if (ids) {
		var sendUrl = "/ajax.jsp?action=manage_getBuyersSupplier_supplierLoss&id=" + ids;
...
function getStateSelect(oid, state) {
	if (oid && state) {		
		$("#exp").html("");
		var sendUrl = "/ajax.jsp?action=manage_getBuyersSupplier_supplierLoss&exec=getLogHtml&oid=" + oid + "&state=" + state + "&is_supp=";
		console.log("sendUrl="+sendUrl);
		$.ajax({
			url: sendUrl,
			type: "get",
...
getStateSelect('GGP20190626192908714564a8','');
$("#viewEdit").validate(
	{debug:false}
);
</script> 
