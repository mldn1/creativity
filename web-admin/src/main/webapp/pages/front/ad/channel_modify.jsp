        ...
        <form action="#" method="post" name="viewEdit" id="viewEdit">
            <table width="98%" class="table table-striped table-hover table-bordered">
                ...
                <tr>
                    <td>id</td>
                    <td>
                        <div class="col-sm-5"><input name="id" type="text" id="id" size="50" value=""
                ...
                <tr>
                    <td>渠道名称</td>
                    <td>
                        <div class="col-sm-5"><input name="name" type="text" id="name" size="50" value=""
                ...
                <tr>
                    <td>推广URL</td>
                    <td>
                        <div class="col-sm-5"><input name="spread" type="url" id="spread" size="100" value=""
                                                     class="form-control"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>回调地址</td>
                    <td>
                        <div class="col-sm-5"><input name="back_url" type="url" id="back_url" size="100" value=""
                                                     class="form-control"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>结算比率</td>
                    <td>
                        <div class="col-sm-5"><input name="rate" type="number" id="rate" size="50" value="100"
                                                     class="form-control"/>
                        </div>
                        %
                    </td>
                ...
                <tr>
                    <td>商务人员</td>
                    <td>
                        <div id="commerce_div" class="col-sm-3"><select name="commerce" id="commerce"
                                                                        class="form-control">
                            <option value="">请选择</option>
                        </select></div>
                    </td>
