...
<form action="?action=main&exec=Contents_logisticsCost&fun=editData" method="post" name="viewEdit" id="viewEdit">
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
            <tr>
        <td>id</td>
        <td><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value="62"  class="form-control"   readonly />
</div></td>
      </tr>
            <tr>
        <td>快递公司</td>
...
<option value="2" selected>顺丰标快</option>
</select></div>
</td>
      </tr>
            <tr>
        <td>抵达城市</td>
        <td><div class="col-sm-5"><input name="city" type="text" id="city" size="50" value="新疆维吾尔"  class="form-control"  required="required" />
</div></td>
      </tr>
            <tr>
        <td>首重钱数</td>
        <td><div class="col-sm-5"><input name="first_weight" type="text" id="first_weight" size="50" value="26.00"  class="form-control"  required="required" />
</div></td>
      </tr>
            <tr>
        <td>续重钱数</td>
        <td><div class="col-sm-5"><input name="add_weight" type="text" id="add_weight" size="50" value="21.00"  class="form-control"  required="required" />
</div></td>
      </tr>
            <tr>
        <td>权重值</td>
        <td><div class="col-sm-5"><input name="weights" type="text" id="weights" size="50" value="1.00"  class="form-control"  required="required" />
</div></td>
      </tr>
            <tr>
        <td>状态</td>
