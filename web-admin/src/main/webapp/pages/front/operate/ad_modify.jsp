...
<form action="?action=main&exec=Contents_adss&fun=editData" method="post" name="viewEdit" id="viewEdit">
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
            <tr>
        <td>id</td>
        <td><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value="141"  class="form-control"   readonly />
</div></td>
      </tr>
            <tr>
        <td>广告名称</td>
        <td><div class="col-sm-5"><input name="title" type="text" id="title" size="50" value="版本更新"  class="form-control"  required="required" />
</div></td>
      </tr>
            <tr>
        <td>广告内容</td>
    ...
    <textarea class="form-control" rows="3"></textarea></td>
            ...
            <tr>
        <td>广告链接</td>
        <td><div class="col-sm-5"><input name="url" type="text" id="url" size="50" value="https://j.youzan.com/-QBLF9"  class="form-control"   />
</div></td>
      </tr>
            <tr>
        <td>广告宽高</td>
        <td><div class="col-sm-5"><input name="wh" type="text" id="wh" size="50" value="750*350"  class="form-control"   />
</div>例：200x100</td>
      </tr>
            <tr>
        <td>广告排序</td>
        ...
        <td><div id="loc_div" style="float: left; width: 100%; text-align: left;"><ul><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="loc[]" type="checkbox" id="loc[]" value="1"  checked />首页(1)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="loc[]" type="checkbox" id="loc[]" value="2"  />分馆页(2)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="loc[]" type="checkbox" id="loc[]" value="3"  />专题页(3)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="loc[]" type="checkbox" id="loc[]" value="4"  />最终页(4)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="loc[]" type="checkbox" id="loc[]" value="99"  />欢迎页(99)&nbsp;</li></ul></div></td>
            ...
            <tr>
        <td>广告定位</td>
        <td><div id="point_div" style="float: left; width: 100%; text-align: left;"><ul><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="point[]" type="checkbox" id="point[]" value="1"  checked />屏首(1)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="point[]" type="checkbox" id="point[]" value="2"  />屏中(2)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="point[]" type="checkbox" id="point[]" value="3"  />屏尾(3)&nbsp;</li></ul></div></td>
      </tr>
            <tr>
        <td>广告类型</td>
        <td><div id="cls_div" style="float: left; width: 100%; text-align: left;"><ul><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="cls[]" type="checkbox" id="cls[]" value="1"  checked />轮播(1)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="cls[]" type="checkbox" id="cls[]" value="2"  />图片(2)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="cls[]" type="checkbox" id="cls[]" value="3"  />文字(3)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="cls[]" type="checkbox" id="cls[]" value="4"  />小程序(4)&nbsp;</li></ul></div></td>
      </tr>
            <tr>
        <td>广告状态</td>
...
<option value="31">草稿</option>
            ...
            <tr>
        <td>绑定商品ID</td>
        <td><div class="col-sm-5"><input name="pid" type="text" id="pid" size="50" value="0"  class="form-control"   />
</div></td>
      </tr>
            <tr>
        <td>所属分馆分类</td>
        ...
        <td>0</td>
            ...
            <tr>
        <td>发表时间</td>
        <td>2018-12-11 19:37:31</td>
      </tr>
            <tr>
        <td>修改时间</td>
        <td>2019-03-21 11:52:08</td>
      </tr>
            <tr>
        <td>操作员</td>
        <td>小张</td>
...
<script>	
UE.getEditor('content',{scaleEnabled:true});</script> 
</div>
</div>
</body>
<script>
