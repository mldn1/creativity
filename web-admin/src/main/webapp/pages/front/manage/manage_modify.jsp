  ...
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td align="left" valign="top"><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value="37"  class="form-control"   readonly />
</div></td>
      </tr>
      <tr>
        <td align="left" valign="top">Email：</td>
        <td align="left" valign="top"><div class="col-sm-5"><input name="email" type="text" id="email" size="50" value="yangjingjing@parbattech.com"  class="form-control"  required="required" readonly="readonly" />
</div></td>
      </tr>
      <tr>
        <td align="left" valign="top">昵称：</td>
        <td align="left" valign="top"><div class="col-sm-5"><input name="nickname" type="text" id="nickname" size="50" value="杨晶晶"  class="form-control"  required="required" />
</div></td>
      </tr>
      <tr>
        <td align="left" valign="top">手机号：</td>
        <td align="left" valign="top"><div class="col-sm-5"><input name="mob" type="text" id="mob" size="20" value="13810000000"  class="form-control"  required="required" />
</div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left" valign="top"><div id="level_div" style="float: left; width: 100%; text-align: left;"><ul><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="0"  />高级管理员(0)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="1"  />编辑人员(1)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="2"  checked />财务(2)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="3"  />客服经理(3)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="30"  />客服(30)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="4"  />商务(4)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="7"  />渠道(7)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="8"  />经理(8)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="40"  />供应商(40)&nbsp;</li><li style="float: left;list-style-type: none; padding-right: 5px; width: 15%;"><input name="level[]" type="checkbox" id="level[]" value="20"  />采购商(20)&nbsp;</li></ul></div></td>
      </tr>
      <tr>
