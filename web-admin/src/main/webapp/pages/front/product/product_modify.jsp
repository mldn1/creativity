  ...
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
        ...
        <td><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value="131"  class="form-control"   readonly />
            ...
            <tr>
        <td>商品唯一码</td>
        <td><div class="col-sm-5"><input name="item_key" type="text" id="item_key" size="50" value="b3e6ac52462a3756"  class="form-control"   readonly />
</div></td>
      </tr>
            <tr>
        <td>产品名称</td>
        <td><div class="col-sm-5"><input name="title" type="text" id="title" size="50" value="荷意年年丝巾"  class="form-control"   required="required" />
</div></td>
      </tr>
            <tr>
        <td>产品短名称</td>
        ...
        <td><div class="col-sm-5"><input name="link_url" type="url" id="link_url" size="50" value=""  class="form-control"   />
            ...
            <tr>
        <td>产品货号</td>
        <td><div class="col-sm-5"><input name="item_no" type="text" id="item_no" size="50" value="SCA-00050"  class="form-control"   required="required" />
</div></td>
      </tr>
            <tr>
        <td>产品简述</td>
        <td><div class="col-sm-5"><input name="description" type="text" id="description" size="50" value="图案为清宫荷包等吉祥物件，寓意和人心意"  class="form-control"   />
</div></td>
      </tr>
            <tr>
        <td>产品标签</td>
