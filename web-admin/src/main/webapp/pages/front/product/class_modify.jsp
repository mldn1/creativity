...
<form action="?action=main&exec=Commodity_commodity_class&fun=editData" method="post" name="viewEdit" id="viewEdit">
  <table width="98%" class="table table-striped table-hover table-bordered">
    ...
    <tbody>
            <tr>
        <td>id</td>
        <td><div class="col-sm-5"><input name="id" type="text" id="id" size="50" value="7"  class="form-control"   readonly />
</div></td>
      </tr>
            <tr>
        <td>order</td>
...
<option value="20">综合馆</option>
            ...
            <tr>
        <td>分类名称</td>
        <td><div class="col-sm-5"><input name="name" type="text" id="name" size="50" value="茶具"  class="form-control"   required="required" />
</div></td>
      </tr>
            <tr>
        <td>分类ICON</td>
