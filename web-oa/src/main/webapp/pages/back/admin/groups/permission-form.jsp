...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      <h3> 组织管理     
        <jsp:include page="/pages/plugins/include_nav.jsp"/>              </h3>
            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="permission-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="name" value="" class="form-control" placeholder="请输入名称，如项目管理">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label"><span>*</span>英文名称</label>
                  <div class="col-sm-10">
                    <input type="text" name="ename" value="" class="form-control" placeholder="请输入英文名称，如project">
                  </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="icon" value="" class="form-control" placeholder="主栏目ICON：user、tasks、suitcase、plane、laptop、home、book">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">排序</label>
                  <div class="col-sm-10">
                    <input type="text" name="weight" value=" " class="form-control" placeholder="数字">
                  </div>
                </div>                
                <div class="form-group">
                  <label class="col-lg-2 col-sm-2 control-label"></label>
                  <div class="col-lg-10">
                    <input type="hidden" name="id" id="permissionid" value=" ">
