...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="javascript:history.back();" class="btn btn-default">返回</a> <a href="approval.jsp" class="hidden-xs btn btn-default" style="padding:4px;">待审批</a> <a href="form.jsp" class="btn btn-success">+我要请假</a> </div>
    </div>
            ...
            <div class="single-blog">
              <div class="panel">
                <div class="panel-body">
                  ...
                  <p class="text-center auth-row"> By <a href="/user/show/{{.leave.Userid}}">XX</a>| 2019 </p>
                  <div id="print">
