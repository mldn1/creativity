...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="/leave/manage" class="btn btn-success" style="padding:4px;">请假</a> <a href="approval.jsp" class="btn btn-default {{if eq .condArr.filter "wait"}}active" style="padding:4px;">待审批</a> <a href="approval.jsp" class="btn btn-default hidden-xs active" style="padding:4px;">已审核</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
      <div class="row">
        <div class="col-sm-12">
          <section class="panel">
            <header class="panel-heading"> 请假 / 总数：<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
