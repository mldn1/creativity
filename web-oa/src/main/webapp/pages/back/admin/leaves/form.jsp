            ...
            <div class="panel-body">
              ...
              <form class="form-horizontal adminex-form" id="leave-form">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="type" class="form-control">
                      ...
                      <option value="1" {{if eq 1 .leave.Type}}selected>事假</option>
                      <option value="2" {{if eq 2 .leave.Type}}selected>病假</option>
                      <option value="3" {{if eq 3 .leave.Type}}selected>年假</option>
                      <option value="4" {{if eq 4 .leave.Type}}selected>调休</option>
                      <option value="5" {{if eq 5 .leave.Type}}selected>婚假</option>
                      <option value="6" {{if eq 6 .leave.Type}}selected>产假</option>
                      <option value="7" {{if eq 7 .leave.Type}}selected>陪产假</option>
                      <option value="8" {{if eq 8 .leave.Type}}selected>路途假</option>
                      <option value="9" {{if eq 9 .leave.Type}}selected>其他</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="days" value=" " class="form-control" placeholder="请输入数字">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <br/>
                    <a href="{{.leave.Picture}}" target="_blank">预览下载</a>  </div>
                </div>
                 <div class="form-group">
