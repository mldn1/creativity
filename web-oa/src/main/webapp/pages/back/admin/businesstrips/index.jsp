...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="header-section">
      ...
      <!--toggle button end-->
      <!--search start-->
      <form class="searchform" action="/businesstrips/manage" method="get">
    ...
    <div class="page-heading">
      ...
      <ul class="breadcrumb pull-left">
        ...
        <li> <a href="pages/back/admin/businesstrips/manage.jsp">审批管理</a> </li>
        <li class="active"> 出差 </li>
      </ul>
      <div class="pull-right"> <a href="pages/back/admin/businesstrips/manage.jsp" class="hidden-xs btn btn-default">全部</a> <a href="pages/back/admin/businesstrips/approval.jsp" class="btn btn-warning" style="padding:4px;">待审批</a> <a href="pages/back/admin/businesstrips/form.jsp" class="btn btn-success">+出差申请</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
      <div class="row">
        <div class="col-sm-12">
          <section class="panel">
            <header class="panel-heading"> 出差 / 总数：<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
                  ...
                  <td> 
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="pages/back/admin/businesstrips/form.jsp">编辑</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-businesstrip-delete" data-op="delete" data-id="">删除</a></li>
                        
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-businesstrip-status" data-op="status" data-id="">正常</a></li>
                        
                      </ul>
                    </div>
                     <a href="pages/back/admin/businesstrips/approval.jsp"> 查看 </a>  </td>
                </tr>
