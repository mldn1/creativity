            ...
            <div class="panel-body">
              ...
              <form class="form-horizontal adminex-form" id="businesstrip-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="days" class="form-control" placeholder="请输入数字">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label"><span>*</span>出差事由</label>
                  <div class="col-sm-10">
                    <textarea name="reason" placeholder="请输入出差事由" style="height:200px;" class="form-control"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <br/>
                    <a href="{{.businesstrip.Picture}}" target="_blank">预览下载</a>  </div>
                </div>
                <div class="form-group">
