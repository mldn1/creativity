...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="javascript:history.back();" class="btn btn-default">返回</a> <a href="pages/back/admin/overtimes/approval.jsp" class="hidden-xs btn btn-default" style="padding:4px;">待审批</a> <a href="pages/back/admin/overtimes/overtimes-add.jsp" class="btn btn-success">+我要加班</a> </div>
    </div>
            ...
            <div class="single-blog">
              <div class="panel">
                <div class="panel-body">
                  ...
                  <p class="text-center auth-row"> By <a href="/user/show/{{.overtime.Userid}}">xxx</a> | 2019 </p>
                  <div id="print">
                  ...
                  <h1 class="text-center cmnt-head">审批人</h1>
                   <div class="media blog-cmnt"> <a href="/user/show/{{$v.Userid}}" class="pull-left"> <img src="{{getAvatar $v.Avatar}}" class="media-object"> </a>
                    <div class="media-body">
                      <h4 class="media-heading"> <a href="/user/show/{{$v.Userid}}"></a> <span class="pull-right"> </span></h4>
