...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"><a href="pages/back/admin/projects/project-add.jsp" class="btn btn-success">添加新项目</a></div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="project-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="aliasname" value="" class="form-control" placeholder="取个代号">
                  </div>
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="projuserid" class="form-control">
                      ...
                      <option value="" {{if eq .Userid $.project.Projuserid}}selected></option></select>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="produserid" class="form-control">
                      ...
                      <option value="" {{if eq .Userid $.project.Produserid}}selected></option></select>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="testuserid" class="form-control">
                      ...
                      <option value="" {{if eq .Userid $.project.Testuserid}}selected></option></select>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="publuserid" class="form-control">
                      ...
                      <option value="" {{if eq .Userid $.project.Publuserid}}selected></option></select>
                  </div>
                </div>
