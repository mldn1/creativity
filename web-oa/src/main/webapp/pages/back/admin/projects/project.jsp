    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <shiro:hasPermission name="oaprogrammer: publish">
                <div class="pull-right"><a href="pages/back/admin/projects/project-add.jsp"
                                ...
                                <form id="project-form-list">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <c:forEach items="${allProjects}" var="project">
                                            <tr>
                                                <td><a href="pages/back/admin/projects/project-detail.jsp?pid="
                                                       + ${project.proid}>${project.title}</a>
                                                </td>
                                                <td>${project.alias}</td>
                                                <td><a href="pages/back/admin/users/profile.jsp">${project.founder}</a>
                                                </td>
                                                <td><a href="/user/show/0">${project.head}</a></td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="pages/back/admin/projects/project-form.jsp">编辑</a>
                                                            </li>
                                                            <li role="separator" class="divider"></li>
                                                            <li><a href="javascript:;" class="js-project-single"
                                                                   data-id="353611856952168448" data-status="1">挂起</a>
                                                            </li>
                                                            <li><a href="javascript:;" class="js-project-single"
                                                                   data-id="353611856952168448" data-status="2">延期</a>
                                                            </li>
                                                            <li role="separator" class="divider"></li>
                                                            <li><a href="javascript:;" class="js-project-single"
                                                                   data-id="353611856952168448" data-status="3">进行</a>
                                                            </li>
                                                            <li><a href="javascript:;" class="js-project-single"
                                                                   data-id="353611856952168448" data-status="4">结束</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
