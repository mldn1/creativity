...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"><a href="pages/back/admin/projects/team.jsp" class="btn btn-success">团队team</a> <a href="pages/back/admin/projects/needs.jsp" class="btn btn-success">需求</a> <a href="pages/back/admin/projects/task.jsp" class="btn btn-success">任务</a> <a href="pages/back/admin/projects/test.jsp" class="btn btn-success">Bug</a> <a href="pages/back/admin/projects/project-chart.jsp" class="btn btn-warning">报表</a></div>
    </div>
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTeams}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTeamsNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartNeedsAccept}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartNeedsAcceptNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartNeedsUser}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartNeedsUserNum}},
	...
	option = {
		    ...
		    legend: {
		        ...
		        data: [ 
				        ...
				        {{getNeedsSource $v.Name}}{{if lt $k $.chartNeedsSourceNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartNeedsSource}}
						{value:{{$v.Value}}, name:{{getNeedsSource $v.Name}}}{{if lt $k $.chartNeedsSourceNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTasksAccept}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTasksAcceptNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTasksUser}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTasksUserNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTasksComplete}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTasksCompleteNum}},
	...
	option = {
		    ...
		    legend: {
		        ...
		        data: [ 
				        ...
				        {{getTaskType $v.Name}}{{if lt $k $.chartTasksSourceNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTasksSource}}
						{value:{{$v.Value}}, name:{{getTaskType $v.Name}}}{{if lt $k $.chartTasksSourceNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTestsAccept}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTestsAcceptNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTestsUser}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTestsUserNum}},
		    ...
		    series : [
		        {
		            ...
		            data:[
						{{range $k,$v := .chartTestsComplete}}
						{value:{{$v.Value}}, name:}{{if lt $k $.chartTestsCompleteNum}},
