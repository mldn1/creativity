  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <ul class="breadcrumb pull-left">
        ...
        <li> <a href="/project/doc/{{.project.Id}}"></a> </li>
            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="doc-form">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="title" value="" class="form-control" placeholder="请输入文档名称">
                  </div>
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="sort" class="form-control">
                      ...
                      <option value="1" {{if eq .docs.Sort 1}}selected>正文</option>
                      <option value="2" {{if eq .docs.Sort 2}}selected>链接</option>
                    </select>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="url" value="" class="form-control" placeholder="http://">
                  </div>
                </div>   
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <br/>
                    <a href="{{.docs.Attachment}}" target="_blank">预览下载</a>  </div>
                </div>
                <div class="form-group">
