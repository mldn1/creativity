                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" id="project-form"
                                  action="pages/back/admin/projects/project_edit.action">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="alias" value="${project.alias}"
                                               class="form-control" placeholder="取个代号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-large custom-date-range" data-date="2016-07-07"
                                            ...
                                            <input type="text" class="form-control dpd2" name="enddate"
                                                   placeholder="结束日期"
                                                   value="${endDate}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select name="head" class="form-control">
                                            ...
                                            <c:forEach items="${allEmps}" var="emp">
                                                <option value="${emp.eid}" ${emp.eid==project.head?"selected":""}>${emp.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="pl" class="form-control">
                                            ...
                                            <c:forEach items="${allEmps}" var="emp">
                                                <option value="${emp.eid}" ${emp.eid==project.pl?"selected":""}>${emp.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="tl" class="form-control">
                                            ...
                                            <c:forEach items="${allEmps}" var="emp">
                                                <option value="${emp.eid}" ${emp.eid==project.tl?"selected":""}>${emp.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="founder" class="form-control">
                                            ...
                                            <c:forEach items="${allEmps}" var="emp">
                                                <option value="${emp.eid}" ${emp.eid==project.founder?"selected":""}>${emp.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <input type="text" class="hidden" name="proid" value="${project.proid}">
