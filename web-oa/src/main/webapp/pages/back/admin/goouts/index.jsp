...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="header-section">
      ...
      <!--toggle button end-->
      <!--search start-->
      <form class="searchform" action="approval.jsp" method="get">
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="pages/back/admin/goouts/approval.jsp" class="hidden-xs btn btn-default">全部</a> <a href="pages/back/admin/goouts/approval.jsp" class="btn btn-warning" style="padding:4px;">待审批</a> <a href="pages/back/admin/goouts/goouts-add.jsp" class="btn btn-success">+我要外出</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
      <div class="row">
        <div class="col-sm-12">
          <section class="panel">
            <header class="panel-heading"> 外出 / 总数：<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
                  ...
                  <td> 
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="pages/back/admin/goouts/form.jsp">编辑</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-goout-delete" data-op="delete" data-id="">删除</a></li>
                        
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-goout-status" data-op="status" data-id="">正常</a></li>
                        
                      </ul>
                    </div>
                     <a href="pages/back/admin/goouts/approval.jsp"> 查看 </a>  </td>
                </tr>
