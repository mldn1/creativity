...
<section> <jsp:include page="/pages/plugins/include_menuitem.jsp"/>
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="pages/back/admin/goouts/approval.jsp" class="btn btn-success" style="padding:4px;">外出</a> <a href="pages/back/admin/goouts/approval.jsp" class="btn btn-default active" style="padding:4px;">待审批</a> <a href="pages/back/admin/goouts/approval.jsp" class="hidden-xs btn btn-default active" style="padding:4px;">已审核</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
            ...
            <div class="panel-body">
              <table class="table table-hover general-table">
                ...
                <tr>
                  ...
                  <td><a href="pages/back/admin/goouts/detail.jsp"> 审批 </a> </td>
                </tr>
