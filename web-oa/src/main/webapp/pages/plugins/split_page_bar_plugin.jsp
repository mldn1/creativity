...
<div id="pagebarDiv" style="float:right">
    <ul class="pagination">
        ...
        %>
        <li>
            <a href="<%=url%>&cp=<%=currentPage - 1%>&ls=<%=lineSize%>&col=<%=column%>&kw=<%=keyword%>&<%=label%>=<%=labelValue%>">&lt;&lt;</a>
        </li>
        <%
        } else {
        %>
        ...
        %>
        <li>
            <a href="<%=url%>&cp=<%=x%>&ls=<%=lineSize%>&col=<%=column%>&kw=<%=keyword%>&<%=label%>=<%=labelValue%>"><%=x%>
            </a>
        </li>
        <%
        } else {
        ...
        <%
            ...
            if (url.contains("?")) {
        %>
        <li><a href="<%=url%>&cp=1&ls=<%=lineSize%>&col=<%=column%>&kw=<%=keyword%>&<%=label%>=<%=labelValue%>">1</a>
        </li>
        <%
        } else {
        %>
        ...
        %>
        <li>
            <a href="<%=url%>&cp=<%=pageSize%>&ls=<%=lineSize%>&col=<%=column%>&kw=<%=keyword%>&<%=label%>=<%=labelValue%>"><%=pageSize%>
            </a></li>
        <%
        } else {
        %>
